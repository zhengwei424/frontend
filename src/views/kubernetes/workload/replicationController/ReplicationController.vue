        ...
        <template slot-scope="scope">
          <el-dropdown trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item icon="el-icon-edit-outline" @click.native="editReplicationController(scope.row)">
                edit/view
              </el-dropdown-item>
              <el-dropdown-item icon="el-icon-delete" @click.native="deleteCurrentReplicationController(scope.row)">
                delete
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
